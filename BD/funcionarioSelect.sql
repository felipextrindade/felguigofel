...
INSERT ALL
  INTO FUNCIONARIO (NrMatric, NmFunc, DtAdm, Sexo, CdCargo, CdDepto) VALUES (1001, 'JOAO SAMPAIO', TO_DATE('10/08/1993', 'dd/mm/yyyy'), 'M', 'C2', 'D2')
  INTO FUNCIONARIO (NrMatric, NmFunc, DtAdm, Sexo, CdCargo, CdDepto) VALUES (1041, 'LUCIO TORRES', TO_DATE('02/03/1994', 'dd/mm/yyyy'), 'M', 'C2', 'D2')
  INTO FUNCIONARIO (NrMatric, NmFunc, DtAdm, Sexo, CdCargo, CdDepto) VALUES (1034, 'ROBERTO PEREIRA', TO_DATE('23/05/1992', 'dd/mm/yyyy'), 'M', 'C3', 'D1')
  INTO FUNCIONARIO (NrMatric, NmFunc, DtAdm, Sexo, CdCargo, CdDepto) VALUES (1021, 'JOSE NOGUEIRA', TO_DATE('10/11/1994', 'dd/mm/yyyy'), 'M', 'C3', 'D1')
  INTO FUNCIONARIO (NrMatric, NmFunc, DtAdm, Sexo, CdCargo, CdDepto) VALUES (1029, 'RUTH DE SOUZA', TO_DATE('05/01/1992', 'dd/mm/yyyy'), 'F', 'C1', 'D3')
  INTO FUNCIONARIO (NrMatric, NmFunc, DtAdm, Sexo, CdCargo, CdDepto) VALUES (1095, 'MARIA DA SILVA', TO_DATE('03/09/1992', 'dd/mm/yyyy'), 'F', 'C4', 'D1')
  INTO FUNCIONARIO (NrMatric, NmFunc, DtAdm, Sexo, CdCargo, CdDepto) VALUES (1023, 'LUIZ DE ALMEIDA', TO_DATE('12/01/1993', 'dd/mm/yyyy'), 'M', 'C2', 'D2')
  INTO FUNCIONARIO (NrMatric, NmFunc, DtAdm, Sexo, CdCargo, CdDepto) VALUES (1042, 'PEDRO PINHEIRO', TO_DATE('29/07/1994', 'dd/mm/yyyy'), 'M', 'C4', 'D1')
  INTO FUNCIONARIO (NrMatric, NmFunc, DtAdm, Sexo, CdCargo, CdDepto) VALUES (1048, 'ANA SILVEIRA', TO_DATE('01/06/1993', 'dd/mm/yyyy'), 'F', 'C5', 'D1')
  INTO FUNCIONARIO (NrMatric, NmFunc, DtAdm, Sexo, CdCargo, CdDepto) VALUES (1015, 'PAULO RODRIGUES', TO_DATE('17/08/1992', 'dd/mm/yyyy'), 'M', 'C2', 'D2')
SELECT * FROM dual;
...
DELETE FROM FUNCIONARIO WHERE CDCARGO = 'C4';
DELETE FROM CARGO WHERE CDCARGO = 'C4';
...
TO_CHAR(SYSDATE, 'YYYY')-TO_CHAR(DTADM,'YYYY') AS "Qnt anos" FROM FUNCIONARIO;
...
SELECT * FROM CARGO 
WHERE NMCARGO NOT LIKE '%MECANICO%' AND NMCARGO NOT LIKE '%COZINHEIRA%';

SELECT * FROM FUNCIONARIO WHERE NRFILHOS IN (2, 4);

SELECT * FROM FUNCIONARIO WHERE NRFILHOS IN (2, 4)
AND (to_char(dtadm, 'yyyy') < 1990);
...
SELECT * FROM FUNCIONARIO WHERE (NRFILHOS < 2 OR NRFILHOS > 3) AND NRFILHOS NOT IN (0);
...
SELECT * FROM FUNCIONARIO WHERE NMFUNC LIKE '%SANTOS%';
...
SELECT NMFUNC, FUNCIONARIO.CDDEPTO FROM FUNCIONARIO, DEPTO
WHERE DEPTO.CDDEPTO != 'D2' AND FUNCIONARIO.CDDEPTO = DEPTO.CDDEPTO;

SELECT * FROM FUNCIONARIO WHERE NMFUNC LIKE '%SILVA%';

SELECT * FROM CARGO WHERE VRSALARIO != 2000;

SELECT NRMATRIC, NMFUNC, NMDEPTO, DEPTO.CDDEPTO FROM FUNCIONARIO, DEPTO
WHERE funcionario.cddepto = depto.cddepto;

SELECT F.NRMATRIC, F.NMFUNC, C.NMCARGO FROM FUNCIONARIO F, CARGO C
